	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			// Simple Para....
				...
				Paragraph paragraph = new Paragraph("The Ikonique Interiors                                                                                         Date: "+sqldate);
				document.add(paragraph);
				document.add(new Paragraph(" "));
				document.add(new Paragraph("Total Earnings Till Today:"+totalearning+" Rs."));
				document.add(new Paragraph(" "));
				document.add(new Paragraph("Here Is The Detailed Report About The Information Of Customer,Product Stock,Earnings,And Interior Designer  "));
				document.add(new Paragraph(" "));
				document.add(new Paragraph(" "));
				document.add(new Paragraph("                                                            Category Information"));
				document.add(new Paragraph(" "));
				//category
				...
				document.add(table);
				document.add(new Paragraph(" "));
				document.add(new Paragraph("                                                            Sub-Category Information"));
				document.add(new Paragraph(" "));
				//subcategory
				...
				document.add(table1);
				document.add(new Paragraph(" "));
				document.add(new Paragraph("                                                                 Product Information"));
				document.add(new Paragraph(" "));
				//product
				...
				document.add(new Paragraph(" "));
				document.add(new Paragraph("                                                            Designer Information"));
				document.add(new Paragraph(" "));
