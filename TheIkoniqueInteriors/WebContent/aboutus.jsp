...
<!-- Favicon -->
<link rel="apple-touch-icon" sizes="120x120" href="neuro/assets/img/favicon/apple-touch-icon.png">
<link rel="icon" type="image/png" sizes="32x32" href="neuro/assets/img/favicon/favicon-32x32.png">
<link rel="icon" type="image/png" sizes="16x16" href="neuro/assets/img/favicon/favicon-16x16.png">
<link rel="manifest" href="neuro/assets/img/favicon/site.webmanifest">
<link rel="mask-icon" href="neuro/assets/img/favicon/safari-pinned-tab.svg" color="#ffffff">
	...
	<h1 class="mr-10">Our Team</h1>
		...
		<div class="page-container">
			<div class="main-content"></div>
			 ...
			 <div class="col-12 col-md-6 col-lg-4 mb-6 mb-md-5 mt-8">
                <!-- Profile Card -->
                    ...
                    <div class="card bg-primary shadow-inset border-light text-center">
                        <div class="card-header">
                            <div class="profile-image bg-primary shadow-inset border border-light rounded mx-auto p-3 mt-n6">
                                <img src="neuro/assets/img/team/profile-picture-4.jpg" class="card-img-top rounded" alt="Leos Portrait">
                            </div>
                        </div>
			...
			<div class="flex-1 justify-center items-center ml-10">
                            <a class="btn btn-sm btn-primary" href="#">
                                Home
                            </a>        
			</div>
